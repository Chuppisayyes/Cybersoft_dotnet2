...
/*
    ...
    -Process: uLong PriceDiscount = % giảm giá * giá tiền
              uLong PriceTotal = giá triền ly trà sữa - tienGiam
...
ulong PriceDiscount = Convert.ToInt64(defaultValueOrder);
ulong PriceTotal = Convert.ToInt32(defaultValueOrder) - Convert.ToInt32(PriceDiscount);
