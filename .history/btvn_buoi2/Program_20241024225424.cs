...
double PriceDiscount = Convert.ToDouble(defaultValueOrder) * Convert.ToInt64(discountPercent) / 100;
double PriceTotal = Convert.ToDouble(defaultValueOrder) - Convert.ToInt32(PriceDiscount);
