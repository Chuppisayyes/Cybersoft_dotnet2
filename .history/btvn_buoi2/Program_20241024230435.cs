...
Console.WriteLine($"Số tiền sau thi cộng thuế VAT: {fomatSoTienGoc + (fomatSoTienGoc * fomatThueVAT / 100)}");
#endregion
...
/*
    ...
    - process:
        double soUSD
        double tyGiaUV ( vd: 1 USD = 25000 VND thì sẽ nhận vào 25000)
...
Console.WriteLine($"Số tiền sau khi chuyển đổi: {fomatSoUSD*fomatTyGiaUV} VND");
#endregion